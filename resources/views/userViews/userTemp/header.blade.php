...
<head>
	...
	<link rel="stylesheet" href="{{ asset('') }}assets/user/css/misc.css">
	<link rel="stylesheet" href="{{ asset('') }}assets/user/css/blue-scheme.css">
	
	<!-- JavaScripts -->
	<script src="{{ asset('') }}assets/user/js/jquery-1.10.2.min.js"></script>
